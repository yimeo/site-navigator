...
$destination = $checker->chooseDestination($website);
if ($destination === null) {
    http_response_code(503);
    $siteName = setting('site_name', app_config()['app_name']);
    ?>
    <!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" href="/assets/css/app.css"><title>暂时无法访问 — <?= e($siteName) ?></title></head>
    <body class="auth-body"><main class="auth-card"><span class="brand-mark">N</span><h1>暂时无法访问</h1><p>“<?= e($website['title']) ?>”的主地址与备用地址当前均未通过连通性检测。请稍后重试，或向管理员反馈。</p><a class="button" href="/">返回导航首页</a></main></body></html>
    <?php
    exit;
}
